  ...
  return (
    <div>
      <Navbar color="dark" dark expand="md">
          ...
          <ul id="navul">
            ...
            <NavItem id="navitem">
              ...
              <ul>
                ...
                <Link to="/userdashboard/profile/:id" id="navlist">
                  Edit Profile
                </Link>
              </ul>
            </NavItem>
            <NavItem id="navitem">
              ...
              <ul>
                ...
                <Link to="/userdashboard/viewdonation" id="navlist">
                  View Donations
                </Link>
              </ul>
            </NavItem>
            <NavItem id="navitem">
              ...
              <ul>
                ...
                <Link to="/userdashboard/viewrequest" id="navlist">
                  View Request
                </Link>
              </ul>
            </NavItem>
        ...
        <NavbarText>
          <Button id="btn-logout" onClick={handleLogout} color="danger">
            Logout
          </Button>
        </NavbarText>
      </Navbar>
